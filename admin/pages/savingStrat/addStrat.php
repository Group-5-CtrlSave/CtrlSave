...
<head>
  ...
  <title>CtrlSave Admin | Add Post</title>
  <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.3/dist/css/bootstrap.min.css" rel="stylesheet">
  <link href="https://fonts.googleapis.com/css2?family=Poppins:wght@400;500;600;700&display=swap" rel="stylesheet">
  <link rel="stylesheet" href="../../assets/css/sideBar.css">
  <link rel="stylesheet" href="../../assets/css/addStrat.css">
...
<body>
  <div class="container main-container my-5">
    <div class="text-start">
      ...
      <p class="add-content-label">Add New Content</p>
    </div>
    ...
    <div class="form-container">
      <form>
        ...
        <!-- Add Button -->
        <button type="submit" class="btn btn-add mt-3">Add</button>
      </form>
    </div>
  </div>
