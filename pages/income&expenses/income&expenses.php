...
<?php include ("../../assets/shared/plusButton.php")?>
    ...
    <div class="container-fluid mainContainer">
        ...
        <div class="container-fluid p-3">
            <h2 class="title">Income and Expenses</h2>
        </div>
        ...
        <div class="container-fluid">
            ...
            <div class="modal fade" id="plusModal" tabindex="-1"
                aria-labelledby="addIncomeExpenseModalLabel" aria-hidden="true">
                <div class="modal-dialog modal-dialog-centered">
                    <div class="modal-content">
                        ...
                        <div class="modal-body d-flex justify-content-center align-items-center">
                            <a href="addIncome.html"><button type="button"
                                    class="btn custom-btn btn-lg addIncomebtn mx-3"><b>Add Income</b></button></a>
                            <a href="addExpenses.html"><button type="button"
            ...
            <div class="col-12">
                <div class="container-fluid ieContainer d-flex justify-content-center align-items-center my-2">
                    ...
                    <div class="container categoryTextContainer p-1">
                        ...
                        <p class="notes m-0">Notes: Pamasahe to...
                        <p>
                    </div>

                    <div class="container iePriceContainer p-1">
                        <h4 class="price m-0">- ₱2000</h4>
