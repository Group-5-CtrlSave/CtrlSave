  ...
  <form method="POST" id="goalForm">
    ...
    <div class="icon-list d-flex flex-column justify-content-between overflow-auto"
      ...
      <div>
        ...
        <div id="balanceError" class="error-message" style="display:none;">Current balance cannot exceed goal amount
        </div>
        <div id="insufficientBalanceError" class="error-message" style="display:none;">Insufficient balance. Available:
          ₱<?php echo number_format($availableBalance, 2); ?></div>
        ...
        <div class="d-flex align-items-center justify-content-between bg-white rounded-3 px-3 mb-3"
          style="height: 50px;">
          <input type="time" name="reminderTime" value="22:00" class="border-0 bg-transparent fw-semibold w-100"
